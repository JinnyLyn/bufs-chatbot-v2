...
테스트 docstring. 예외는 그대로 둔다: GitHub 화면의 버튼 이름("Publish release"), 명령어·코드·
에러 문자열, 고유명사·기술 용어(필요하면 한국어 뒤에 괄호로 영어 병기). 스크립트(`scripts/*.sh`)
주석과 실행 메시지는 기존 파일의 관례(영어)를 따른다 — 운영자 한 명이 보는 도구이고 기존 스크립트가
전부 영어라서. 이 규칙은 2026-09-10 사용자 지시.
