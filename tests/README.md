...
H100의 LLM은 **Ollama로 서빙**된다. 서버에서는 `scripts/stack.sh start` 가 팀 소유 ollama(:11500)와 함께 스택을 띄우고, 원격
...
./scripts/stack.sh start        # 서버에서 (ollama :11500 + backend :8000 + frontend :3000)
